...
if not os.path.isfile('pipe.pkl'):
    st.error("Model file 'pipe.pkl' not found. Please check the file path.")
else:
    ...
    try:
        ...
        st.error(f"Module not found during loading: {e}")
    except Exception as e:
        st.error(f"An error occurred while loading the model: {e}")

if not os.path.isfile('df.pkl'):
    st.error("Data file 'df.pkl' not found. Please check the file path.")
else:
    ...
    try:
        ...
        st.error("The data file 'df.pkl' was not found.")
    except Exception as e:
